...
struct FindTabView: View {
    ...
    private var biomeCardWidth: CGFloat {
        169
    }
...
private struct FindDataQualityCard: View {
    var body: some View {
        HStack(spacing: 24) {
            FindQualityItem(
                title: "Casual Grade",
                imageName: "find-dq-casual",
                isActive: true
            )
            FindQualityItem(
                title: "Needs ID",
                imageName: "find-dq-needs-id",
                isActive: true
            )
            FindQualityItem(
                title: "Research Grade",
                imageName: "find-dq-research",
                isActive: false
            )
        }
        ...
        ZStack(alignment: .topLeading) {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text(title)
                        .font(.custom("NewSpirit-Regular", size: 15))
                        .foregroundStyle(GaiaColor.paperWhite50)
                        .frame(maxWidth: .infinity, alignment: .leading)
                        .lineLimit(2)
                    ...
                    HStack(spacing: 2) {
                        ...
                        Text(count)
                            .font(.custom("Neue Haas Unica W1G", size: 9.34))
                            .foregroundStyle(GaiaColor.paperWhite50)
                            .tracking(0.23)
                    }
                }
