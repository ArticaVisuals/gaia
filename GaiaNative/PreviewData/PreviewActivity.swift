...
enum PreviewActivity {
    static let events: [ActivityEvent] = [
        ActivityEvent(
            ...
            actionLabel: nil,
            categoryIDs: ["needs-attention"],
            style: .notification,
            thumbnailAssetName: "activity-thumb-anna-hummingbird"
        ),
        ActivityEvent(
            id: "evt-2",
            groupLabel: "Today",
            ...
            actionLabel: nil,
            categoryIDs: ["id-updates"],
            style: .notification,
            thumbnailAssetName: "activity-thumb-western-fence-lizard"
        ),
        ActivityEvent(
            id: "evt-3",
            groupLabel: "Today",
            ...
            actionLabel: nil,
            categoryIDs: ["id-updates"],
            thumbnailAssetName: "activity-thumb-monarch-butterfly"
        ),
        ActivityEvent(
            id: "evt-4",
            groupLabel: "Yesterday",
            title: "Draft saved",
            subtitle: "You started a find and saved it for later: Unknown Plant",
            timestampLabel: "6:14 PM",
            actionLabel: nil,
            categoryIDs: ["needs-attention"],
            thumbnailAssetName: "activity-thumb-unknown-plant"
        ),
        ActivityEvent(
            id: "evt-5",
            groupLabel: "Yesterday",
            ...
            actionLabel: nil,
            categoryIDs: ["id-updates"],
            thumbnailAssetName: "activity-thumb-coopers-hawk"
        ),
        ActivityEvent(
            id: "evt-6",
            groupLabel: "Yesterday",
            ...
            actionLabel: nil,
            categoryIDs: ["needs-attention"],
            thumbnailAssetName: "activity-thumb-mushroom-detail"
        )
    ]
